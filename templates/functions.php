...
function akpsi_rhopsi_resources() {
...
add_action('wp_enqueue_scripts', 'akpsi_rhopsi_resources');
...
add_action('after_setup_theme', 'akpsi_rhopsi_setup');
